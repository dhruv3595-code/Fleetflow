...
const ROLE_KPIS = {
  ...
  Analyst: () => [
    { label: "Total Fuel Cost", value: "₹1.2L", sub: "This month", icon: <FiDroplet size={18} />, color: "var(--warning)" },
    { label: "Avg Cost/km", value: "₹4.8", sub: "Across all vehicles", icon: <FiBarChart2 size={18} />, color: "var(--accent)", trend: "3%", trendDir: "down" },
    { label: "Top Expense", value: "Fuel", sub: "62% of total spend", icon: <FiActivity size={18} />, color: "var(--danger)" },
    { label: "Monthly Savings", value: "₹18K", sub: "vs last month", icon: <FiCheckCircle size={18} />, color: "var(--success)", trend: "8%", trendDir: "up" },
  ],
};
        ...
        <div className="page-body">
          ...
          <div className="dash-grid">
            ...
            {showVehicleTable ? (
              ...
              <div className="panel">
                <div className="panel-header">
                  <div className="panel-title">Expense Breakdown — This Month</div>
                  <button className="panel-action" onClick={() => onNavigate("fuel")}>View Details →</button>
                </div>
                <div style={{ padding: "24px 20px" }}>
                  {[
                    { label: "Fuel", amount: "₹74,200", pct: 62, color: "var(--warning)" },
                    { label: "Maintenance", amount: "₹28,500", pct: 24, color: "var(--danger)" },
                    { label: "Tolls", amount: "₹10,800", pct: 9, color: "var(--accent)" },
                    { label: "Other", amount: "₹6,100", pct: 5, color: "var(--muted)" },
                  ].map((item, i) => (
